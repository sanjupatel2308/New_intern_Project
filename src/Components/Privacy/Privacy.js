    ...
    <div className="container" data-aos="fade-up">
      ...
      <div className="privacy-content" data-aos="fade-up">
        ...
        <div className="content-section">
          ...
          <p>
            We automatically collect and store certain information when you use
            our services:
          </p>
          <ul>
        ...
        <div className="content-section">
          ...
          <p>
            ...
            individuals outside of our company when we have your consent to do
            so.
          </p>
        ...
        <div className="content-section">
          ...
          <ul>
            ...
            <li>
              We restrict access to personal information to employees who need
              that information
            </li>
          </ul>
        </div>
